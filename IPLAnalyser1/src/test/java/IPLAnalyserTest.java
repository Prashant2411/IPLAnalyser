...
public class IPLAnalyserTest {
    ...
    public String INCORRECT_FILE = "/home/admin1/Documents/Prashant/IPLAnalyzer/src/test/resources/Batting";
    public String INCORRECT_FILE_FORMAT = "/home/admin1/Documents/Prashant/IPLAnalyzer/src/test/resources/InvalidHeader.csv";
    ...
    public void givenMostRunCSV_shouldReturnCorrectValues() throws CsvBuilderException {
        try {
            iplAnalyser = new IPLAnalyser(ComparatorToSort.Sorting_Fields.COMPARE_6s_4s, IPLAnalyser.BatOrBowl.BATTING);
    ...
    @Test
    public void givenIPLCSV_shouldReturnTopBattingAverages() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLCSV_shouldReturnMOst6sAnd4s() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLCSV_shouldReturnMOst6sAnd4sWithStrikeRate() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLCSV_shouldReturnMostStrikeRateWithAverages() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLCSV_shouldReturnMostRunsWithStrikeRate() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLBowlCSV_shouldReturnTopBowlingAverages() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLBowlCSV_shouldReturnTopBowlingStrikerRate() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLBowlCSV_shouldReturnTopBowlingEconomyRate() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLBowlCSV_shouldReturnHeighestAverageWithStrikeRate() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLBowlCSV_shouldReturnMost5And4WicketWithStrikeRate() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenIPLBowlCSV_shouldReturnWicketsWithAverage() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenBattingBowlingCSV_shouldReturnBestBattingBowlingAvg() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenBattingBowlingCSV_shouldReturnBestAllRounder() throws CsvBuilderException {
        try {
    ...
    @Test
    public void givenInvalidPath_shouldThrowException() throws CsvBuilderException {
        try {
            IPLAnalyser iplAnalyser = new IPLAnalyser(ComparatorToSort.Sorting_Fields.COMPARE_6s_4s, IPLAnalyser.BatOrBowl.BATTING);
    ...
    @Test
    public void givenInvalidHeader_shouldThrowException() throws CsvBuilderException {
        try {
            IPLAnalyser iplAnalyser = new IPLAnalyser(ComparatorToSort.Sorting_Fields.COMPARE_6s_4s, IPLAnalyser.BatOrBowl.BATTING);
